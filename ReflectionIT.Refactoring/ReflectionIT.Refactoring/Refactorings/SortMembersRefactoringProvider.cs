...
namespace ReflectionIT.Analyzer.Refactorings {
    ...
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(SortMembersRefactoringProvider)), Shared]
    public class SortMembersRefactoringProvider : CodeRefactoringProvider {
        ...
        public sealed override async Task ComputeRefactoringsAsync(CodeRefactoringContext context) {
            ...
            if (!(node is TypeDeclarationSyntax clsDecl)) {
                return;
            }

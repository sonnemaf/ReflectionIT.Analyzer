...
namespace ReflectionIT.Analyzer.Analyzers.OptionalParameterInPublicClassPublicMethod {
    ...
    public class OptionalParameterInPublicClassPublicMethodAnalyzer : DiagnosticAnalyzer {
        ...
        private static DiagnosticDescriptor _rule = new DiagnosticDescriptor(DiagnosticId, _title, _messageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: _description);

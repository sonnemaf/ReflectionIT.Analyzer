...
namespace ReflectionIT.Analyzer.Refactorings {
    ...
    namespace MoveClassToFile {
        ...
        // Source: https://raw.githubusercontent.com/filipw/Strathweb.Roslyn/master/MoveClassToFile/MoveClassToFile/MoveClassToFileCodeRefactoringProvider.cs
        ...
        internal class MoveTypeToFileCodeRefactoringProvider : CodeRefactoringProvider {
            ...
            public sealed override async Task ComputeRefactoringsAsync(CodeRefactoringContext context) {
                ...
                var action = CodeAction.Create("Move type to seperate file", c => MoveClassIntoNewFileAsync(context.Document, typeDecl, c));
